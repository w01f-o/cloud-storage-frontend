...
export const triggerVariants = tv({
  base: 'group focus:outline-none data-[placeholder]:text-foreground/50 select-none flex h-12 w-full gap-2 items-center justify-between rounded-md border-2 border-primary bg-transparent px-3 py-2.5 whitespace-nowrap shadow-md disabled:!cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
});
...
export const itemVariants = tv({
  base: 'focus:bg-default/10 transition-colors-background-opacity relative gap-2 flex w-full cursor-pointer items-center py-3 pr-8 pl-2.5 outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
});
